# v2.3.0 Release Notes
 ...
 - Telemetry: WG Desktop uses [glean.js](https://github.com/mozilla/glean.js/) to collect anonymized user-interaction data.  Users have the option to opt out of any data collection.
 - In-app surveys: Users are invited to provide feedback on WG Desktop.
