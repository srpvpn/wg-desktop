...
SETTING_STRING(activeWireGuardProfileId,        // getter
               setActiveWireGuardProfileId,     // setter
               removeActiveWireGuardProfileId,  // remover
               hasActiveWireGuardProfileId,     // has
               "wireGuard/activeProfileId",     // key
               "",                              // default value
...
SETTING_BYTEARRAY(wireGuardProfiles,        // getter
                  setWireGuardProfiles,     // setter
                  removeWireGuardProfiles,  // remover
                  hasWireGuardProfiles,     // has
                  "wireGuard/profiles",     // key
                  "",                       // default value
                  true,                     // remove when reset
                  true  // sensitive (contains private keys)
)
